...
const Cart = ({ route, navigation }) => {
  ...
  addedCartItems.forEach((item) => {
    subtotal +=
      item["price"] * (itemQuantity == 0 ? item.quantity : itemQuantity);
  });
        ...
        <View style={{ alignItems: "center" }}>
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => {
                if (
                  (itemQuantity == 0 && item.quantity == 1) ||
                  itemQuantity == 1
                )
      ...
      <View style={styles.subContainer}>
        ...
        <View style={{ flex: 1, marginTop: 70 }}>
          <ScrollView>
            ...
            {isDiscount ? (
              <View>
                <Text style={{ color: "green" }}>{confirmationMessage}</Text>
              </View>
            ) : (
              <View>
              ...
              <ScrollView>
                ...
                <View style={{ alignItems: "center" }}>
                  ...
                  <View style={{ justifyContentContent: "center" }}>
                    ...
                    >
                      <View
                        style={[styles.button, { backgroundColor: "#9F4146" }]}
                      >
